  ...
  return <>
    ...
    <section className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
      <div className="flex flex-wrap items-start justify-between gap-4 border-b border-gray-200 p-6">
        ...
        <button onClick={() => { setModal({ mode: 'add' }); setQuantity(0); }} className="inline-flex h-10 items-center justify-center gap-2 rounded-lg bg-[#EE1C25] px-4 text-sm font-medium text-white transition-colors hover:bg-[#EE1C25]"><Plus size={17}/>Add stock item</button>
      </div>
